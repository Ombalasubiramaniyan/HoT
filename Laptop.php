...
<body>
    <div class="container py-4 my-4 mx-auto d-flex flex-column">
        <div class="header">
                            ...
                            $sql = "select * from laptop  where pid='{$_GET["id"]}'";
                            $res = $conn->query($sql);
                            if ($res->num_rows > 0) {
                                ...
                                if ($row = $res->fetch_assoc()) {
                                    ...
                                    <div class="row r3">
                                        <div class="col-md-5 p-0 klo">
                                            <ul class="">
                            <li><strong>BRAND :' . $row['PNAME'] . '</strong></li>
                            <li><strong>RAM :' . $row['RAM'] . '</strong></li>
                            <li><strong>STORAGE :' . $row['STORAGE'] . '</strong></li>
                            <li><strong>PROCESSOR :' . $row['PROC'] . '</strong></li>
                            <li><strong>Easy Returns</strong></li>
                            <li class="text-danger"><strong> Rs.' . $row['PRICE'] . '</strong> <h6 style="color:blue;">Orginal Price: <s class="orgprice">' . $row['ORG PRICE'] . '</s></h6></li>
                        </ul>
                    ...
                    <div class="col-md-2" style="width:30%"> <img src="images/lap/' . $row['PIC'] . '"> </div>
                </div>
            </div>
            <div class="footer d-flex flex-column mt-3">
                <div class="row r8">
               <input type="text"  placeholder="Enter Qty"  value="1" name="qty"  class="qty">
               <a href="#mail.php" class="buy">buy</a>
               <input type="text"  placeholder="Enter Qty" name="qty"  value="1" class="qty">
