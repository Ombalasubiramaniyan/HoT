...
<head>
    ...
    <link rel="stylesheet" href="css/acc_product.css">
</head>
...
<body>
    ...
    <div class="container py-4 my-4 mx-auto d-flex flex-column">
        <div class="header">
                            ...
                            $sql = "select * from acc  where pid='{$_GET["id"]}'";
                            $res = $conn->query($sql);
                            if ($res->num_rows > 0) {
                            ...
                            <li><strong>' . $row['PNAME'] . '</strong></li>
                            <li><strong>' . $row['DETAIL'] . '</strong></li>
                    ...
                    <div class="col-md-2"> <img src="images/acc/' . $row['PIC'] . '" width="120%"></div>
                </div>
            </div>
