    ...
    <div class="container py-4 my-4 mx-auto d-flex flex-column">
        ...
        <?php
                            if (isset($_POST["addCart"])) {
                             ...
                             $sql = "select * from womens  where pid='{$_GET["id"]}'";
                            $res = $conn->query($sql);
                            if ($res->num_rows > 0) {
                                ...
                                if ($row = $res->fetch_assoc()) {
                                    ...
                                    <div class="row r3">
                                        <div class="col-md-5 p-0 klo">
                                            ...
                                            <ul>
                            <li><strong>This is ' . $row['PNAME'] . '</strong></li>
                            <li><strong>' . $row['MODEL'] . '</strong></li>
                    ...
                    <div class="col-md-2"> <img src="images/girls/' . $row['PIC'] . '"style="width:110%"></div>
                </div>
            </div>
